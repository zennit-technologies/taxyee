...
class HowitWorkResource extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()) {
            ...
            return view('cms.page.howitwork', compact('data'));
        }
    }
    ...
    {
        return view('cms.page.howitwork_create');
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('cms.page.howitwork_edit',compact('service'));
        } catch (ModelNotFoundException $e) {
            return back()->with('flash_error', 'Service Type Not Found');
        }
    }
