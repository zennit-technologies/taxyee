...
class AdminHowitWorkResource extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $data = Page::where($locale.'_title','how it work')->get();
        if($request->ajax()) {
            return $data;
        } else {
            return view('admin.pages.page.howitwork', compact('data'));
        }
    }
    ...
    {
        return view('admin.pages.page.howitwork_create');
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.pages.page.howitwork_edit',compact('service'));
        } catch (ModelNotFoundException $e) {
            return back()->with('flash_error', 'Service Type Not Found');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.how-it-work.index')->with('flash_success', 'Page Updated Successfully');    
        } 
