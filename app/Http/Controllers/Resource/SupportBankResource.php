...
class SupportBankResource extends Controller
{
    /**
    ...
    public function new_account(Request $request)
    {
        ...
        if($request->ajax()) {
            ...
            return view('support.bank.new_account', compact('bank'));
        }
    }
    ...
    public function approved_account(Request $request)
    {
        ...
        $bank = BankAccount::where('status','APPROVED')->get();
            ...
            return view('support.bank.approved_account', compact('bank'));
    ...
    $bank = WithdrawalMoney::where('status','APPROVED')->get();
     return view('support.bank.approved_withdraw', compact('bank'));
      ...
      public function new_withdraw(Request $request)
    {
       ...
       return $arr;
            ...
            return view('support.bank.new_withdraw', compact('bank'));
        }
    ...
    {
        return view('support.blog.create');
    }
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('support.bank.edit',compact('service'));
        } catch (ModelNotFoundException $e) {
            return back()->with('flash_error', 'Account Not Found');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('support/approved_account')->with('flash_success', 'Account Updated Successfully');    
        } 
