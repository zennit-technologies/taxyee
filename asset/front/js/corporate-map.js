...
function createRideInitialize() {
    ...
    // console.log('current_Lat:'+current_Lat+'current_long:'+current_long);
...
function addMarkerToMap(element) {
          //console.log('Ajax Response', element);
        ...
        marker = new google.maps.Marker({
         ...
         var content = "<p>Name : "+element.first_name+" "+element.last_name+"</p>"+
