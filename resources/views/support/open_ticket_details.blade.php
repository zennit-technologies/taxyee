...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <!-- <a href="{{ route('support.openTicket', 'open') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a> -->

			<h5 style="margin-bottom: 2em;">Open Ticket Details</h5>

            <form class="form-horizontal" action="{{route('support.transfer', $data->id )}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<button type="submit" class="btn btn-success shadow-box">Reply</button>

						<a href="{{ route('support.openTicket', 'open') }}" class="btn btn-default">Cancel</a>
