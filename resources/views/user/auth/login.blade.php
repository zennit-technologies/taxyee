        ...
        <div class="row no-margin">
            ...
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    ...
                    <div class="col-md-12">
                        <a href="{{ url('/auth/facebook') }}"><button type="button" class="log-teal-btn fb"><i class="fa fa-facebook"></i>LOGIN WITH FACEBOOK</button></a>
                    </div>  
                    <div class="col-md-12">
                        <a href="{{ url('/auth/google') }}"><button type="button" class="log-teal-btn gp"><i class="fa fa-google-plus"></i>LOGIN WITH GOOGLE+</button></a>
                    </div>
                    @endif -->
