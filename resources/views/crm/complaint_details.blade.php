...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <a href="{{ route('crm.complaint') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a>
            ...
            <form class="form-horizontal" action="{{route('crm.transfer', $data->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						...
						<a href="{{route('crm.complaint')}}" class="btn btn-default">Cancel</a>
					</div>
				</div>
			</form>
		</div>
