    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box b-a-0" style="top: 132px; box-shadow: none;height: 448px;">
                ...
                <form class="form-material mb-1" role="form" method="POST" action="{{ url('/crm/login') }}" >
                {{ csrf_field() }}
        ...
        <div class="col-md-8">
        <img src="{{asset('asset/front_dashboard/img/login.jpg')}}" alt="CRM Panel" style="width: 100%;">
        </div>
    </div>
</div>
@endsection
