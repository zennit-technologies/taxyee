    ...
    <div class="row row-md">
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-primary mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Total Vehicle</h6>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-warning  mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Cancelled Ride</h6>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-primary mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Cancelled Ride(user)</h6>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-danger mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Cancelled Ride(provider)</h6>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-warning mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Total Vendor</h6>
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-block bg-success mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Scheduled Ride</h6>
