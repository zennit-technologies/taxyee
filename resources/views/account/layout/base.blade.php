...
<head>
    ...
    <!-- Title -->
    <title>@yield('title'){{ Setting::get('site_title', 'ilyft') }}</title>
...
<body class="fixed-sidebar fixed-header content-appear skin-1">
    ...
    <div class="wrapper">
        ...
        @include('account.layout.partials.header')
        @include('account.layout.partials.nav')
        
        <div class="page-content dashboard-page">  
            <div class="site-content no-margin">
                @include('common.notify')
                @yield('content')
                @include('account.layout.partials.footer')
            </div>
        </div>
    </div>
