...
<div class="content-area py-1">
    ...
    <div class="container-fluid">
    	...
    	<div class="box box-block bg-white">
            ...
            <!-- <a href="{{ route('admin.testimonial.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a> -->
            ...
            <form class="form-horizontal" action="{{route('admin.testimonial.store')}}" method="POST" enctype="multipart/form-data" role="form">
