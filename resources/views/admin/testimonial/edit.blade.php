...
<div class="content-area py-1">
    ...
    <div class="container-fluid">
    	...
    	<div class="box box-block bg-white">
            ...
            <!-- <a href="{{ route('admin.testimonial.index', $testimonial->id ) }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a> -->
            ...
            <form class="form-horizontal" action="{{route('admin.testimonial.update', $testimonial->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.testimonial.index')}}" class="btn btn-default">Cancel</a>
					</div>
				</div>
			</form>
