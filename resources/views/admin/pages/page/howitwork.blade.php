...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1"><span class="s-icon"><i class="ti-layout"></i></span>&nbsp;How It Works List</h5><hr>
            <a href="{{ route('admin.how-it-work.create') }}" style="margin-left: 1em;" class="btn btn-success shadow-box btn-rounded pull-right"><i class="fa fa-plus"></i>Add New</a>
                ...
                @foreach($data as $index => $service)
                    <tr>
                       ...
                       <!--  <td>
                        ...
                        <td>
                            <form action="{{ route('admin.how-it-work.destroy', $service->id) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <a href="{{ route('admin.how-it-work.edit', $service->id) }}" class="btn btn-success shadow-box">
