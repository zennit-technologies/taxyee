...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
           <!--  <a href="{{ route('admin.how-it-work.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i>Back</a> -->

            <h5 style="margin-bottom: 2em;"><span class="s-icon"><i class="ti-layout"></i></span>&nbsp;Update Page</h5><hr>
            <form class="form-horizontal" action="{{route('admin.how-it-work.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="profile" role="tabpanel" aria-expanded="true">
                             <div class="form-group row">
                                <label for="name" class="col-xs-12 col-form-label">Page Name</label>
                                <div class="col-xs-10">
                                    <input class="form-control arabic-content" type="text" value="{{ $service->ar_title }}" name="ar_title" required id="ar_title" placeholder="Title">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control arabic-content" type="text" value="{{ $service->ar_question }}" name="ar_question" required id="ar_question" placeholder="Question">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="description" class="col-xs-12 col-form-label">Description</label>
                                <div class="col-xs-10">
                                    <textarea class="form-control arabic-content" id="ar_myeditor"  type="number"  name="ar_description" required  placeholder="Description" rows="4">{{ $service->ar_description }}</textarea>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="tab-pane" id="profile_1" role="tabpanel" aria-expanded="true">
                             <div class="form-group row">
                                <label for="name" class="col-xs-12 col-form-label">Page Name</label>
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $service->fr_title }}" name="fr_title" required id="fr_title" placeholder="Title">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $service->fr_question }}" name="fr_question" required id="fr_question" placeholder="Question">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="description" class="col-xs-12 col-form-label">Description</label>
                                <div class="col-xs-10">
                                    <textarea class="form-control" id="fr_description"  type="number"  name="fr_description" required  placeholder="Description" rows="4">{{ $service->fr_description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="profile_2" role="tabpanel" aria-expanded="true">
                             <div class="form-group row">
                                <label for="name" class="col-xs-12 col-form-label">Page Name</label>
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $service->ru_title }}" name="ru_title" required id="ru_title" placeholder="Title">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $service->ru_question }}" name="ru_question" required id="ru_question" placeholder="Question">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="description" class="col-xs-12 col-form-label">Description</label>
                                <div class="col-xs-10">
                                    <textarea class="form-control" id="ar_myeditor"  type="number"  name="ru_description" required  placeholder="Description" rows="4">{{ $service->ru_description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="profile_3" role="tabpanel" aria-expanded="true">
                             <div class="form-group row">
                                <label for="name" class="col-xs-12 col-form-label">Page Name</label>
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $service->sp_title }}" name="sp_title" required id="sp_title" placeholder="Title">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $service->sp_question }}" name="sp_question" required id="sp_question" placeholder="Question">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="description" class="col-xs-12 col-form-label">Description</label>
                                <div class="col-xs-10">
                                    <textarea class="form-control" id="ru_myeditor"  type="number"  name="sp_description" required  placeholder="Description" rows="4">{{ $service->sp_description }}</textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3  offset-md-6">
                        <a href="{{route('admin.how-it-work.index')}}" class="btn btn-danger shadow-box btn-block">Cancel</a>
                    </div>
