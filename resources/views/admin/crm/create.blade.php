...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><i class="ti-layout-media-right"></i>&nbsp;Add Crm</h5><hr>

            <form class="form-horizontal" action="{{route('admin.crm-manager.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
