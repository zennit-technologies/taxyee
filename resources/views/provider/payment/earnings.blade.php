                            ...
                            <div class="earning-element row no-margin">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                                    <div class="earning-box">
                                        ...
                                        <p class="dashboard-txt">RIDES COMPLETED TODAY</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                                    <div class="earning-box">
                                        ...
                                        <p class="dashboard-txt">DAILY RIDE TARGET </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                                    <div class="earning-box">
                                        ...
                                        <p class="dashboard-txt">FULLY COMPLETED RIDES</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="row no-margin">
                                        <div class="pull-left trip-left">
                                            <h3 data-toggle="collapse" data-target="#demo1" class="accordion-toggle collapsed acc-tit">
                                                <span class="arrow-icon fa fa-chevron-right"></span>Ride Earnings
                                            </h3>
                                        </div>
                                    </div>
