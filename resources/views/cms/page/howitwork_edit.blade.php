...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <!-- <a href="{{ route('cms.how-it-work.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i>Back</a> -->

            <h5 style="margin-bottom: 2em;"><span class="s-icon"><i class="ti-layout"></i></span>&nbsp;Update Page</h5><hr>
            <form class="form-horizontal" action="{{route('cms.how-it-work.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3  offset-md-4">
                        <a href="{{route('cms.how-it-work.index')}}" class="btn btn-danger shadow-box btn-block">Cancel</a>
                    </div>
