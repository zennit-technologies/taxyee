...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1"><span class="s-icon"><i class="ti-car"></i></span>&nbsp;Vehicle Allocation</h5>
            <div class="row">
                <div class="col-xs-12">
                ...
                <form action="{{ route('fleet.provider.document.store', $Provider->id) }}" method="POST">
                    ...
                    <div class="col-xs-3">
                        <select class="form-control input" name="service_type" required>
                            ...
                            @empty
                            <option>- Please Create a Vehicle -</option>
                            @endforelse
                        </select>
                    </div>
                    <div class="col-xs-3">
                    ...
                    <div class="col-xs-3">
                        <button class="btn btn-success shadow-box btn-block" type="submit">Update</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="box box-block bg-white">
            <h5 class="mb-1">Driver Documents</h5>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group-btn">
                                <a href="{{ route('fleet.provider.document.edit', [$Provider->id, $Document->id]) }}"><span class="btn btn-success btn-large shadow-box">View</span></a>
                                <button class="btn btn-danger shadow-box btn-large" form="form-delete">Delete</button>
