...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1"><i class="ti-map-alt"></i>&nbsp;Map View</h5>
            <div class="row">
                <div class="col-xs-12">
                    <div id="map"></div>
...
<script>
    ...
    var mapIcons = {
        ...
        active: '{{ asset("asset/front/img/marker-car.png") }}',
        riding: '{{ asset("asset/front/img/marker-active.png") }}',
        offline: '{{ asset("asset/front/img/marker-home.png") }}',
        unactivated: '{{ asset("asset/front/img/marker-plus.png") }}'
    }
