...
<script>
   ...
   var mapIcons = {
        ...
        complete: '{{ asset("asset/img/blue.png") }}',
        riding: '{{ asset("asset/img/yellow.png") }}',
   ...
   function initMap() {
      ...
      function getData(map){
        ...
        $.get('{{url("dispatcher/get-locations")}}/'+type).then(res=>{
            clearMarkers();
            setMarkers(map, res)
        })
      }
        ...
        for (var i = 0; i < beaches.length; i++) {
          ...
          var content = 'Content not found.';
            ...
            return function() {
               ...
               var url1 = '{{url("dispatcher/get-details")}}/'+beach.icon+"/"+beach.id;
               $.get(url1).then(res=>{
                  if(res) {
                    content = res;
