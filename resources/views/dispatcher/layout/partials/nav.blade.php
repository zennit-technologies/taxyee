<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
            <li class="menu-title">Recent Trips Dashboard</li>
            <li>
				<a href="{{ route('dispatcher.new_booking') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-target"></i></span>
					<span class="s-text">New Booking </span>
				</a>
            </li>
			<li>
				<a href="{{ route('dispatcher.index') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-target"></i></span>
					<span class="s-text">Recent Trips</span>
				</a>
			</li>
            <li>
				<a href="{{ route('dispatcher.map.index') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-map-alt"></i></span>
					<span class="s-text">Live  Traking</span>
				</a>
			</li>
