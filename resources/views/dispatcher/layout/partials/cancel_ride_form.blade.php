		...
		<div class="modal-content">
			<form id="cancel_ride_form">
			  ...
			  <div class="modal-header">
					<h4 class="modal-title pull-left">Cancellation Reason</h4>
			  ...
			  <!-- Modal body -->
				<div class="modal-body">
					<div class="form-group">
						...
						<textarea class="form-control" rows="5" name="cancel_reason"></textarea>
					</div>
				</div>	
				<div class="modal-footer">
					<a class="btn btn-block shadow-box" id="submit_reason_btn" style="background-color: #b01d23;color: #fff !important; font-weight: bold;">SUBMIT</a>
				</div>
			</form>
		</div>
	</div>
